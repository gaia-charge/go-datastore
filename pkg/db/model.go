...
type NullAuthMethodType struct {
	...
	Valid          bool           `json:"valid"` // Valid is true if AuthMethodType is not NULL
}
...
type NullAuthenticationActions struct {
	AuthenticationActions AuthenticationActions `json:"authenticationActions"`
	Valid                 bool                  `json:"valid"` // Valid is true if AuthenticationActions is not NULL
}
...
type NullChannelRequestStatus struct {
	ChannelRequestStatus ChannelRequestStatus `json:"channelRequestStatus"`
	Valid                bool                 `json:"valid"` // Valid is true if ChannelRequestStatus is not NULL
}
...
type NullChargingPeriodDimensionType struct {
	ChargingPeriodDimensionType ChargingPeriodDimensionType `json:"chargingPeriodDimensionType"`
	Valid                       bool                        `json:"valid"` // Valid is true if ChargingPeriodDimensionType is not NULL
}
...
type NullCommandResponseType struct {
	CommandResponseType CommandResponseType `json:"commandResponseType"`
	Valid               bool                `json:"valid"` // Valid is true if CommandResponseType is not NULL
}
...
type NullConnectorFormat struct {
	ConnectorFormat ConnectorFormat `json:"connectorFormat"`
	Valid           bool            `json:"valid"` // Valid is true if ConnectorFormat is not NULL
}
...
type NullEnergySourceCategory struct {
	EnergySourceCategory EnergySourceCategory `json:"energySourceCategory"`
	Valid                bool                 `json:"valid"` // Valid is true if EnergySourceCategory is not NULL
}
...
type NullEnvironmentalImpactCategory struct {
	EnvironmentalImpactCategory EnvironmentalImpactCategory `json:"environmentalImpactCategory"`
	Valid                       bool                        `json:"valid"` // Valid is true if EnvironmentalImpactCategory is not NULL
}
...
type NullEvseStatus struct {
	EvseStatus EvseStatus `json:"evseStatus"`
	Valid      bool       `json:"valid"` // Valid is true if EvseStatus is not NULL
}
...
type NullImageCategory struct {
	ImageCategory ImageCategory `json:"imageCategory"`
	Valid         bool          `json:"valid"` // Valid is true if ImageCategory is not NULL
}
...
type NullPowerType struct {
	...
	Valid     bool      `json:"valid"` // Valid is true if PowerType is not NULL
}
...
type NullRoundingGranularity struct {
	RoundingGranularity RoundingGranularity `json:"roundingGranularity"`
	Valid               bool                `json:"valid"` // Valid is true if RoundingGranularity is not NULL
}
...
type NullRoundingRule struct {
	RoundingRule RoundingRule `json:"roundingRule"`
	Valid        bool         `json:"valid"` // Valid is true if RoundingRule is not NULL
}
...
type NullRoutingEventStatus struct {
	RoutingEventStatus RoutingEventStatus `json:"routingEventStatus"`
	Valid              bool               `json:"valid"` // Valid is true if RoutingEventStatus is not NULL
}
...
type NullRoutingEventType struct {
	RoutingEventType RoutingEventType `json:"routingEventType"`
	Valid            bool             `json:"valid"` // Valid is true if RoutingEventType is not NULL
}
...
type NullSessionStatusType struct {
	SessionStatusType SessionStatusType `json:"sessionStatusType"`
...
type NullTariffDimension struct {
	TariffDimension TariffDimension `json:"tariffDimension"`
	Valid           bool            `json:"valid"` // Valid is true if TariffDimension is not NULL
}
...
type NullTokenAllowedType struct {
	TokenAllowedType TokenAllowedType `json:"tokenAllowedType"`
	Valid            bool             `json:"valid"` // Valid is true if TokenAllowedType is not NULL
}
...
type NullTokenWhitelistType struct {
	TokenWhitelistType TokenWhitelistType `json:"tokenWhitelistType"`
	Valid              bool               `json:"valid"` // Valid is true if TokenWhitelistType is not NULL
}
